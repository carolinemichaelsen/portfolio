...
<div className="m-12 pt-10 sm:pt-18 lg:pt-24">
  <div>
    <h3 className='text-zinc-900 font-bold text-4xl text-center mb-8 font-serif'>Projetos</h3>
  </div>
  <div className='flex flex-row columns-3 p-20 items-stretch gap-8'>
    ...
    <div className="p-5 bg-zinc-400 opacity-90 rounded-lg outline hover:outline-zinc-300">
      <p className="text-zinc-900 font-bold text-s p-2 font-h3">Clone do Spotify Web</p>
      ...
      <div className='flex flex-col p-4'>
        <p className='text-xs text-justify max-w-xs mb-2'>Reprodução da interface do Spotify Web, construída com <b>React</b>, <b>TypeScript</b> e <b>Tailwind.</b></p>
    ...
    {/* PROJETO 2 */}
    <div className="p-5 bg-zinc-400 opacity-90 rounded-lg outline hover:outline-zinc-300">
      <p className=" space text-zinc-900 font-bold text-s font-h3">Site responsivo</p>
